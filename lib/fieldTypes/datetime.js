...
var parseFormats = ['DD.MM.YYYY', 'DD.MM.YYYY HH:mm:ss','YYYY-MM-DD', 'YYYY-MM-DD h:m:s a', 'YYYY-MM-DD h:m a', 'YYYY-MM-DD H:m:s', 'YYYY-MM-DD H:m'];
...
function datetime(list, path, options) {
	...
	this._underscoreMethods = ['dateformat', 'format', 'moment', 'parse'];
 ...
 */
datetime.prototype.dateformat = function(){
...
datetime.prototype.updateItem = function(item, data) {
	...
	var newValue = moment(this.getInputFromData(data), this._formatString);
